      ...
      <div className="">
        <div className="relative">
          <img
            src={blog.image_one}
            alt={blog.title}
            className="w-full h-48 sm:h-64 md:h-80 mb-2 rounded-lg object-cover"
          />
        ...
        <div className="flex items-center justify-between sm:justify-around my-2 sm:my-3 px-2 sm:px-0">
          <div className="flex items-center gap-1">
            <IoIosHeartEmpty className="w-5 h-5 sm:w-6 sm:h-6 cursor-pointer" />
            <span className="text-sm sm:text-base">{blog.likes}</span>
          </div>
          <div className="flex items-center gap-1">
            <FaRegComment className="w-5 h-5 sm:w-6 sm:h-6 cursor-pointer" />
            <span className="text-sm sm:text-base">{blog.comments.length}</span>
          </div>
          <CiBookmark className="w-5 h-5 sm:w-6 sm:h-6 cursor-pointer" />
          <PiShareFatLight className="w-5 h-5 sm:w-6 sm:h-6 cursor-pointer" />
        </div>
      </div>
    </div>
  );
